  ...
  return (
    <>
      <header className="bg-gray-700 text-white px-4 pt-6 pb-16 sm:!rounded-t-2xl flex justify-between">
        <div>
          <div>{__('Welcome', 'favcrm-for-woocommerce')}</div>
      ...
      <div className="px-4 grid gap-y-4 pb-4">
        <div className="bg-white rounded-3xl flex flex-col items-center w-full -mt-8 px-4 py-6">
          <div className="font-medium mb-2">
            {sprintf(__('Become %s\'s member', 'favcrm-for-woocommerce'), site.title)}
          </div>
          {
          ...
          <a href="/account-register" className="bg-gray-700 hover:bg-gray-500 duration-300 text-white px-6 py-2 rounded-full text-sm mb-4">{__('Register', 'favcrm-for-woocommerce')}</a>
          <div className="text-sm">{__('Already a member?', 'favcrm-for-woocommerce')} <a href="/account-login" className="underline underline-offet-2 text-gray-500">{__('Login', 'favcrm-for-woocommerce')}</a></div>
        </div>
        <div className="bg-white rounded-3xl flex flex-col items-center w-full px-4 py-6">
          <div className="font-medium mb-2">
            {sprintf(__('%s Points', 'favcrm-for-woocommerce'), site.title)}
          </div>
          <div className="text-gray-500 text-sm mb-6">{__('Earn points and rewards', 'favcrm-for-woocommerce')}</div>
          <div
          ...
          >
            <div className="flex items-center">
              ...
              <div>{__('Earn Reward Points', 'favcrm-for-woocommerce')}</div>
            </div>
