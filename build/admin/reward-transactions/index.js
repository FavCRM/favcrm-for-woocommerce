...
/***/ "./src/admin/reward-transactions/screens/list.js":
/*!*******************************************************!*\
  !*** ./src/admin/reward-transactions/screens/list.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RewardTransactionList)
/* harmony export */ });
...
function RewardTransactionList(_ref) {
  ...
  var pageLink = "/fav/v1/reward-transactions?page=".concat(currPage, "&page_size=20");
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Reward Transaction List', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("hr", {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Member', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    id: "transactionType",
    className: "manage-column column-amount"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Transaction Type', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    id: "transactionObject",
    className: "manage-column column-amount"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Transaction Object', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    id: "Change",
    className: "manage-column column-amount"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Change', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    id: "date",
    ...
    var _row$member, _row$spendingRecord, _row$spendingRecord$a, _row$spendingRecord2, _row$points, _row$stamps;
    return /*#__PURE__*/React.createElement("tr", {
      key: row.id,
      id: "transaction-".concat(row.id),
    ...
    }, "Select Transaction #", row.id), /*#__PURE__*/React.createElement("input", {
      ...
      className: "screen-reader-text"
    }, "Transaction #".concat(row.id, " is locked")))), /*#__PURE__*/React.createElement("td", {
      ...
      className: ""
    }, (_row$member = row.member) === null || _row$member === void 0 ? void 0 : _row$member.name), " ")), /*#__PURE__*/React.createElement("td", {
      className: "phone column-transaction-type",
      "data-colname": "Transaction Type"
    }, /*#__PURE__*/React.createElement("div", {
      className: ""
    }, row.transactionType)), /*#__PURE__*/React.createElement("td", {
      className: "points column-transaction-object",
      "data-colname": "Transaction Object"
    }, /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true"
    }, !!((_row$spendingRecord = row.spendingRecord) !== null && _row$spendingRecord !== void 0 && _row$spendingRecord.amount) && "Spending for ".concat((_row$spendingRecord$a = +((_row$spendingRecord2 = row.spendingRecord) === null || _row$spendingRecord2 === void 0 ? void 0 : _row$spendingRecord2.amount)) === null || _row$spendingRecord$a === void 0 ? void 0 : _row$spendingRecord$a.toLocaleString("en-US", {
      style: "currency",
      currency: "USD"
    }))), /*#__PURE__*/React.createElement("span", {
      className: "screen-reader-text"
    }, "No tags")), /*#__PURE__*/React.createElement("td", {
      className: "points column-change",
      "data-colname": "Change"
    }, /*#__PURE__*/React.createElement("div", {
      className: +row.points > 0 ? 'text-green-600' : 'text-red-500'
    }, +row.points > 0 && '+', !!row.points && ((_row$points = +row.points) === null || _row$points === void 0 ? void 0 : _row$points.toLocaleString("en-HK", {
      style: 'decimal',
      minimumFractionDigits: '2'
    })) + ' Points'), /*#__PURE__*/React.createElement("div", {
      className: +row.stamps > 0 ? 'text-green-600' : 'text-red-500'
    }, +row.stamps > 0 && '+', !!row.stamps && ((_row$stamps = +row.stamps) === null || _row$stamps === void 0 ? void 0 : _row$stamps.toLocaleString("en-HK", {
      style: 'decimal'
    })) + ' Stamps')), /*#__PURE__*/React.createElement("td", {
    ...
    scope: "col",
    className: "manage-column column-member"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Member', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    className: "manage-column column-transaction-type"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Transaction Type', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    className: "manage-column column-transaction-object"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Transaction Object', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    className: "manage-column column-change"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Change', 'favcrm-for-woocommerce')), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    className: "manage-column column-date sortable asc"
...
"use strict";
/*!**************************************************************!*\
  !*** ./src/admin/reward-transactions/reward-transactions.js ***!
  \**************************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _screens_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./screens/list */ "./src/admin/reward-transactions/screens/list.js");
...
if (document.getElementById('favored-admin-reward-transaction')) {
  ...
  var element = document.getElementById('favored-admin-reward-transaction');
  var nonce = element.getAttribute('data-nonce');
  var router = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_3__.createMemoryRouter)([{
    path: '/',
  ...
  (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(element).render(/*#__PURE__*/React.createElement(_tanstack_react_query__WEBPACK_IMPORTED_MODULE_4__.QueryClientProvider, {
    client: queryClient
  }, /*#__PURE__*/React.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_5__.RouterProvider, {
    router: router
  })));
}
})();
