...
/***/ "./src/admin/billing/screens/billing.js":
/*!**********************************************!*\
  !*** ./src/admin/billing/screens/billing.js ***!
  \**********************************************/
...
function Billing(_ref) {
  ...
  var _useQuery2 = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_4__.useQuery)({
    ...
    subscriptionData = _useQuery2.data,
    isSubscriptionDataLoading = _useQuery2.isLoading,
    refetch = _useQuery2.refetch;
  var _useMutation = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_5__.useMutation)({
      mutationFn: function () {
        var _mutationFn = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_ref2) {
          var priceId, subscriptionId, result;
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                priceId = _ref2.priceId, subscriptionId = _ref2.subscriptionId;
                _context3.next = 3;
                return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  var handlePlanChange = function handlePlanChange(priceId) {
    mutate({
      priceId: priceId,
      subscriptionId: subscriptionData === null || subscriptionData === void 0 ? void 0 : subscriptionData.stripeSubscriptionId
    });
  };
  var getSubscriptionButtonText = function getSubscriptionButtonText(item) {
    if (isSubscriptionDataLoading || isMutating) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_LoadingSpinner__WEBPACK_IMPORTED_MODULE_3__["default"], {
        isLoading: isMutating,
        color: "text-black",
        size: "size-4"
      });
    }
    if (item.id === (subscriptionData === null || subscriptionData === void 0 ? void 0 : subscriptionData.plan)) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  }, __('Billing', 'favcrm-for-woocommerce')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: "mt-0 text-gray-500 font-normal"
  }, __('Manage billing and your subscription plan.', 'favcrm-for-woocommerce')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", {
    className: "wp-header-end"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid md:grid-cols-3 gap-6"
  }, isLoading && Array(3).fill(0).map(function (_, index) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: index,
      className: "bg-white shadow rounded p-4"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "animate-pulse rounded-md bg-[#AAA] h-6 w-1/2 mb-1"
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "animate-pulse rounded-md bg-[#AAA] h-6 w-1/4 mb-2"
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "animate-pulse rounded-md bg-[#AAA] h-6 w-1/4"
    }));
  }), data === null || data === void 0 || (_data$items = data.items) === null || _data$items === void 0 ? void 0 : _data$items.map(function (item) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: item.id,
      className: "bg-white shadow rounded p-4"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    }, item.name), parseFloat(item.price) === 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
      className: "text-gray-500"
    }, "Free"), parseFloat(item.price) !== 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
      className: "text-gray-500"
    }, "$", parseFloat(item.price), "/mo")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      className: "my-0 text-gray-500"
    }, item.description), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
      className: "list-disc list-inside mt-2"
    }, item.features.map(function (feature) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
        key: feature.name
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, feature.value), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "\xA0"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, feature.name));
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "mt-4"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      disabled: item.id === (subscriptionData === null || subscriptionData === void 0 ? void 0 : subscriptionData.plan) || isMutating || !subscriptionData,
      className: classnames__WEBPACK_IMPORTED_MODULE_2___default()('button button-primary', {
...
/* harmony import */ var _screens_billing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./screens/billing */ "./src/admin/billing/screens/billing.js");



var element = document.getElementById('favored-admin-billing');
if (element) {
  ...
  (0,react_dom_client__WEBPACK_IMPORTED_MODULE_0__.createRoot)(element).render(/*#__PURE__*/React.createElement(_tanstack_react_query__WEBPACK_IMPORTED_MODULE_3__.QueryClientProvider, {
    client: queryClient
  }, /*#__PURE__*/React.createElement(_screens_billing__WEBPACK_IMPORTED_MODULE_1__["default"], {
    nonce: nonce
  })));
}
})();
